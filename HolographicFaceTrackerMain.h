...
namespace HolographicFaceTracker {
	...
	public:
		...
		bool IsReadyToRender(void) const {
		...
		void on_source_pressed(SpatialInteractionManager ^ sender, SpatialInteractionSourceEventArgs ^ args);
	...
	private:
		...
		bool showing_all_information = false;
	};
}
