...
void AppView::SetWindow(CoreWindow^ window) {
	...
	SpatialInteractionManager::GetForCurrentView()->SourcePressed += ref new TypedEventHandler<SpatialInteractionManager ^, SpatialInteractionSourceEventArgs ^>(this, &AppView::on_source_pressed);
...
void HolographicFaceTracker::AppView::on_source_pressed(SpatialInteractionManager ^ sender, SpatialInteractionSourceEventArgs ^ args) {
	m_main->on_source_pressed(sender, args);
}
